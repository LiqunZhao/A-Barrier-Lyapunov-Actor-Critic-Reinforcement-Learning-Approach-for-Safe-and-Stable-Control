...
class CBFQPLayer:
    ...
    def get_safe_action_without_lya(self, para_lam,state_batch, mean_pred_batch, sigma_batch,lya_grads_batch,lyapunov_value,time_batch,obs_batch,cur_pos_vel_info,episode_steps):
    ...
    def get_cbf_qp_constraints_without_lya(self, state_batch, mean_pred_batch, sigma_pred_batch,lya_grads_batch,lyapunov_value,time_batch):
        ...
        if self.env.dynamics_mode == 'SimulatedCars':
            ...
            lya_obj[:,0,:n_u] = torch.bmm(lya_grads_batch.view(batch_size, 1, -1), lya_g_x_star.view(batch_size, -1, 1))
